 ...
 */
public class RestartableEmbeddedCassandraServerHelper {

    private static Logger log = LoggerFactory.getLogger(RestartableEmbeddedCassandraServerHelper.class);
    ...
    public static void startEmbeddedCassandra(String yamlFile, String tmpDir, long timeout) throws TTransportException, IOException, ConfigurationException {
        ...
        //rmdir(tmpDir);  // Don't delete - allows for restarting
    ...
    public static void startEmbeddedCassandra(File file, String tmpDir, long timeout) throws IOException, ConfigurationException {
        ...
        // Don't delete existing dirs - allows for restarting
        makeOrLeaveDirs();
    ...
    private static Path copy(String resource, String directory) throws IOException {
        ...
        //Files.copy(from, copyName);  // Just overwrite... allows for retarting
        Files.copy(from, copyName, StandardCopyOption.REPLACE_EXISTING);
        return copyName;
    }
